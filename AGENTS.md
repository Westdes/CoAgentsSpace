...
- Do not persist session IDs in local config. Session IDs may appear only in appended thread entries.
...
- Threads live under `threads/THREAD-0001.md` in the CAS space.
- Thread frontmatter is immutable after creation.
